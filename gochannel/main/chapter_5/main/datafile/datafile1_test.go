...
func TestIDataFile(t *testing.T) {
	t.Run("datafile", func(t *testing.T) {
		dataLen := uint32(3) //C:/Users/sllEc_000/go/src/gochannel/main/chapter_5/main/datafile/
...
func testRW(path string, dataLen uint32, max int, t *testing.T) {
	...
	if err != nil {
		t.Logf("Could't new a data file: %s", err)
		t.FailNow()
	}
